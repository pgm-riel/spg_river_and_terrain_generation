...
void main()
{
	...
	out_color.xyz = light_color * PhongLight(wPos, wNorm).xyz +vec3(1,1,1) * 0.6;
}

// -----------------------------------------------------------------------------
// Phong Light

const vec3 ld = vec3 (0.9f);	// Diffuse factor
const vec3 ls = vec3 (0.4);	// Specular factor
const float specular_exponent = 60.0;	// Specular exponent
...
vec4 PhongLight(vec3 w_pos, vec3 w_N)
{
	...
	// TODO
	// Ignore fragments outside of the light influence zone (radius)
